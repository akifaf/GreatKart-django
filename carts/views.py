...
def add_cart(request, product_id):
    ...
    if current_user.is_authenticated:
        ...
        if request.method == "POST":
            # for item in request.POST:
                ...
                try:
                    ...
                    existing_cart_item = CartItem.objects.filter(product=product, variations=variation, user=current_user).first()
                    ...
                    if existing_cart_item:
                        ...
                        cart_item = CartItem.objects.create(product=product, quantity=1, user=current_user, variations=variation)
                        cart_item.save()
                except:
                    pass
        ...
        #     cart_item = CartItem.objects.filter(product=product, variations__color__color__iexact=color, variations__size__size__iexact=size, user=current_user)
        #     print(cart_item , 'cartidflksadj')
        ...
        #         #increment the cart_item quantity
